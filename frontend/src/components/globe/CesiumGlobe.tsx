 ...
 * CesiumGlobe
 *
 * Polar 3D Geospatial Globe visualization engine built upon CesiumJS WebGL.
 *
 * Core Architectural Capabilities:
 * 1. High-Performance WebGL Primitives:
 *    Renders 40,000+ grounded icebergs, drifting tracks, and global ports simultaneously using
 *    low-level `PointPrimitiveCollection`, `BillboardCollection`, and `PolylineCollection`
 *    rather than heavy DOM/Entity abstractions.
 * 2. 3D Ellipsoid Horizon Occlusion:
 *    Calculates screen-space window coordinates for floating UI annotations (ports, vessel badges,
 *    iceberg tooltips) while strictly accounting for Earth curvature and camera frustum bounds.
 * 3. Maritime Navigation Corridors:
 *    Renders calculated polar maritime paths with luminous corridor buffers, waypoints, and heading vectors.
 * 4. Interactive Hit Testing:
